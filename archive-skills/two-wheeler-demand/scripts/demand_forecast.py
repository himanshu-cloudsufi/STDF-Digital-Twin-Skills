"""
Demand Forecasting Module for Two-Wheeler Market
...
class DemandForecaster:
    """Forecasts demand for two-wheeler market, EV, and ICE segments"""
    ...
    def forecast_market(
        ...
        """
        Forecast total two-wheeler market demand using linear extrapolation with CAGR cap
    ...
    def forecast_ev(
        ...
        """
        Forecast EV two-wheeler demand using logistic adoption model
    ...
    def forecast_ice(
        ...
        """
        Forecast ICE two-wheeler demand as residual
...
def run_demand_forecast(
    ...
    market_years, market_hist = data_loader.get_demand_data("Two_Wheelers", region)
    ev_years, ev_hist = data_loader.get_demand_data("EV_2_Wheelers", region)
    ...
    if track_fleet:
        try:
            # Calculate fleet evolution (11-year lifetime for two-wheelers)
            ev_fleet = forecaster.calculate_fleet_evolution(
                ev_demand, years, lifetime_years=11.0
            )
            ice_fleet = forecaster.calculate_fleet_evolution(
                ice_demand, years, lifetime_years=11.0
            )
...
if __name__ == "__main__":
    ...
    print("Testing Two-Wheeler Demand Forecasting...")
