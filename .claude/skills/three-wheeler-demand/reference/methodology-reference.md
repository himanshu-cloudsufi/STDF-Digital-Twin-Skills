# Three-Wheeler Demand Forecasting Methodology Reference

## Overview

This document provides detailed methodology for cost-driven three-wheeler demand forecasting with EV disruption analysis.
...
**Input Data:**
- EV Primary: `EV_3_Wheeler_(Range-100_KM)_Lowest_Cost_{Region}`
- ICE Baseline: `Three_Wheeler_(ICE)_Median_Cost_{Region}`
...
where:
  lifetime_years = 10 (three-wheelers)
```
...
where regions = {China, Europe, Rest_of_World}
```
...
4. **10-Year Vehicle Life**: Average lifetime for fleet calculations (commercial use)
...
- Three-Wheeler Market Analysis: Industry reports (2020-2024)
