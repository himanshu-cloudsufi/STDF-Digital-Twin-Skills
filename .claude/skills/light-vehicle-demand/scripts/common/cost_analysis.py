"""
Cost Analysis Module for Light Vehicle Demand Forecasting
...
class CostAnalyzer:
    """Analyzes cost curves and determines tipping points for light vehicle EV adoption"""

    def __init__(self, vehicle_type: str = "light vehicle", smoothing_window: int = 3):
        """
        Initialize cost analyzer

        Args:
            vehicle_type: Type of vehicle being analyzed (for display purposes)
    ...
    def prepare_cost_curves(
        ...
        """
        Prepare and forecast cost curves for EV and ICE vehicles
...
def run_cost_analysis(
    ...
    vehicle_type: str = "light vehicle"
) -> Dict[str, any]:
    """
    ...
    Args:
        ...
        vehicle_type: Type of vehicle being analyzed (for display)
    ...
    # Initialize analyzer
    analyzer = CostAnalyzer(vehicle_type=vehicle_type, smoothing_window=3)
...
if __name__ == "__main__":
    # Test cost analysis
    print("Testing Light Vehicle Cost Analysis...")
    print("This module is designed to be imported and used with a DataLoader instance.")
    print("\nExample usage:")
    print("  from common.cost_analysis import run_cost_analysis")
    print("  from common.data_loader import DataLoader")
    print("  loader = DataLoader(vehicle_config)")
    print("  result = run_cost_analysis(loader, 'China', end_year=2030)")
