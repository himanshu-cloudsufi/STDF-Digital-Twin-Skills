...
description: Forecast commodity demand driven by product sales and component replacement cycles. Handles metals (copper, lithium, lead, cobalt, aluminum, nickel for batteries and motors) and energy commodities (oil, coal, natural gas for power generation and transportation). Use when user asks about commodity demand, material requirements, material needs, supply needs, supply forecast, resource requirements, peak demand years, raw material demand, battery materials, mining demand, or questions like "when will lithium demand peak", "what is copper demand for EVs in 2035", "how much lead will be needed", "forecast copper demand driven by vehicles", "oil demand for transportation sector", "when will coal demand peak", "lithium supply requirements for batteries", "what are the material needs for EV production", "how much copper per EV", "installed base replacement demand". Calculates demand from BOTH new product sales AND installed base replacements. Covers regions: China, USA, Europe, Rest_of_World, Global. Trigger keywords: commodity, material, metal, resource, supply, demand, peak, copper, lithium, lead, cobalt, aluminum, nickel, oil, coal, gas, battery materials, raw material, mining, intensity, replacement, installed base, 2040, 2050.
---
